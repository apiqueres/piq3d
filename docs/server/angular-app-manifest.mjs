...
export default {
  ...
  assets: {
    ...
    'gracias/index.html': {size: 68007, hash: 'd3139ef48a791a6e4e7fec710c455a1014bc2da8ea5a656ed347895f9700d892', text: () => import('./assets-chunks/gracias_index_html.mjs').then(m => m.default)},
