...
export default {
  ...
  assets: {
    ...
    'gracias/index.html': {size: 68007, hash: '5e60cd992643906c02d448d7bd679e2eb57eb3689d5b78c99847f7c49986c9d8', text: () => import('./assets-chunks/gracias_index_html.mjs').then(m => m.default)},
